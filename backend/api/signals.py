    ...
    def do_create():
        if created:
            ...
            if old_verified != new_verified and new_verified in HIGH_CRIT:
                ...
                create_notif(event=event, notif_title=f"{head}: {title}", body=body, severity=new_verified)
            ...
            if old_status != "resolved" and new_status == "resolved":
                ...
                if sev in HIGH_CRIT:
                    ...
                    create_notif(event="resolved", notif_title="Hazard cleared / resolved", body=body, severity=sev)
