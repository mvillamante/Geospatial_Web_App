...
urlpatterns = [
    ...
    path("hazard/calamity-risk/ai-insight/", calamity_risk_ai_insight, name="hazard_calamity_risk_ai_insight"),
    path("hazard/calamity-risk/import-ai-insight/", calamity_risk_import_ai_insight, name="hazard_calamity_risk_import_ai_insight"),
    path("hazard/green-index/", green_index, name="hazard_green_index"),
    path("hazard/green-index/ai-insight/", green_index_ai_insight, name="hazard_green_index_ai_insight"),
    path("hazard/green-index/import-ai-insight/", green_index_import_ai_insight, name="hazard_green_index_import_ai_insight"),
    path("hazard/hazard-index/", hazard_index, name="hazard_hazard_index"),
    path("hazard/hazard-index/ai-insight/", hazard_index_ai_insight, name="hazard_hazard_index_ai_insight"),
    path("hazard/hazard-index/import-ai-insight/", hazard_index_import_ai_insight, name="hazard_hazard_index_import_ai_insight"),
